...
import defaultUBLExtensionsSignedProperties, { defaultUBLExtensionsSignedPropertiesForSigning, } from "../templates/ubl_extension_signed_properties_template.js";
 ...
 */
export const getPureInvoiceString = (invoice_xml) => {
 ...
 */
export const getInvoiceHash = (invoice_xml) => {
 ...
 */
export const getCertificateHash = (certificate_string) => {
 ...
 */
export const createInvoiceDigitalSignature = (invoice_hash, private_key_string) => {
    const invoice_hash_bytes = Buffer.from(invoice_hash, "base64");
    const cleanedup_private_key_string = cleanUpPrivateKeyString(private_key_string);
 ...
 */
export const getCertificateInfo = (certificate_string) => {
    const cleanedup_certificate_string = cleanUpCertificateString(certificate_string);
 ...
 */
export const cleanUpCertificateString = (certificate_string) => {
 ...
 */
export const cleanUpPrivateKeyString = (certificate_string) => {
    return certificate_string
 ...
 */
export const generateSignedXMLString = ({ invoice_xml, certificate_string, private_key_string, }) => {
    const invoice_copy = new XMLDocument(invoice_xml.toString({ no_header: false }));
    // 1: Invoice Hash
    ...
    // UBL Extensions
    let ubl_signature_xml_string = defaultUBLExtensions(invoice_hash, signed_properties_hash, digital_signature, cleanUpCertificateString(certificate_string), ubl_signature_signed_properties_xml_string);
    // Set signing elements
    let unsigned_invoice_str = invoice_copy.toString({
        no_header: false,
    });
    ...
    let signed_invoice_string = signed_invoice.toString({
        no_header: false,
    });
